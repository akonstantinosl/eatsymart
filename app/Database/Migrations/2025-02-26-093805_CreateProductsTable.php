...
class CreateProductsTable extends Migration
{
    public function up()
    {
        $this->forge->addField([
            ...
            'purchase_price'     => ['type' => 'FLOAT', 'constraint' => '10,2'],  
            'selling_price'      => ['type' => 'FLOAT', 'constraint' => '10,2'],  
            ...
            'box_purchase_price' => ['type' => 'FLOAT', 'constraint' => '10,2', 'null' => true],
            'box_selling_price'  => ['type' => 'FLOAT', 'constraint' => '10,2', 'null' => true], 
