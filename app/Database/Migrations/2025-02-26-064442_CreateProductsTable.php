...
class CreateProductsTable extends Migration
{
    public function up()
    {
        $this->forge->addField([
            ...
            'selling_price'      => ['type' => 'DECIMAL', 'constraint' => '10,2'],  
            ...
            'unit_per_box'       => ['type' => 'INT', 'constraint' => 11, 'null' => true], 
            'box_purchase_price' => ['type' => 'DECIMAL', 'constraint' => '10,2', 'null' => true],
            'box_selling_price'  => ['type' => 'DECIMAL', 'constraint' => '10,2', 'null' => true], 
            'box_bought'         => ['type' => 'INT', 'constraint' => 11, 'null' => true],
